...
parser.add_argument('agentt_type',type=str,choices=['Ant','AntSquaT','HCallv6','HCez','HCE1','HCAll','VA','VAez',
...
#################################################################################################################
    ...
    if plot_type=='line':
        ASA_fig_ax.plot(FP_SAC, ASA_SAC, color=sac_color, linewidth=LW,marker="x",markersize=20,markeredgewidth=5,label='SAC')
        if name_tag != 'VA' and name_tag !='RealArmAllv4':
            ASA_fig_ax.fill_between(FP_SAC, ASA_SAC + ASA_SAC_std,
                                ASA_SAC - ASA_SAC_std, facecolor=sac_color, alpha=trans_rate)

        for index,d in enumerate(Dof_list):
            ASA_fig_ax.text(FP_SAC[index]*1.01,ASA_SAC[index]*0.95,d+ ' DOF',va='center',  ha='left')
    else:
        ASA_fig_ax.bar(FP_SAC, ASA_SAC, yerr=ASA_SAC_std, color='g', width=barwidth, edgecolor='white')

    ASA_fig_ax.set_title('ASA vs Performance '+name_tag+' SAC')
    ...
    if get_rid_div:
        if fixed_scale:
            if not save_svg:
                plt.savefig(cwd + '/experiments_results/Synergy/ASA_vs_P_'+plot_type+'_plot/'+name_tag+'/ASA_'+plot_type+'_SAC_fixed_scale_'+name_tag+'_no_div.png')
            else:
                plt.savefig(cwd + '/experiments_results/Synergy/ASA_vs_P_'+plot_type+'_SVGplot/'+name_tag+'/ASA_'+plot_type+'_SAC_fixed_scale_'+name_tag+'_no_div.svg')

        else:
            plt.savefig(cwd + '/experiments_results/Synergy/ASA_vs_P_'+plot_type+'_plot/'+name_tag+'/ASA_'+plot_type+'_SAC_'+name_tag+'_no_div.png')
    else:
        if fixed_scale:
            plt.savefig(
                cwd + '/experiments_results/Synergy/ASA_vs_P_'+plot_type+'_plot/' + name_tag + '/ASA_'+plot_type+'_SAC_fixed_scale_' + name_tag + '.png')
        else:
            plt.savefig(
                cwd + '/experiments_results/Synergy/ASA_vs_P_'+plot_type+'_plot/' + name_tag + '/ASA_'+plot_type+'_SAC_' + name_tag + '.png')

    ASA_fig, ASA_fig_ax = plt.subplots(1, 1)

    if plot_type=='line':
        ASA_fig_ax.plot(FP_TD3, ASA_TD3, color=td3_color, linewidth=LW,marker=".",markersize=20,markeredgewidth=5,label='TD3')
        if name_tag != 'VA' and name_tag !='RealArmAllv4':
            ASA_fig_ax.fill_between(FP_TD3, ASA_TD3 + ASA_TD3_std,
                                ASA_TD3 - ASA_TD3_std, facecolor=td3_color, alpha=trans_rate)

        for index,d in enumerate(Dof_list):
            ASA_fig_ax.text(FP_TD3[index]*1.01,ASA_TD3[index]*0.9,d+ ' DOF',va='center',  ha='left')
    ...
    if get_rid_div:
        if fixed_scale:
            if not save_svg:
                plt.savefig(cwd + '/experiments_results/Synergy/ASA_vs_P_'+plot_type+'_plot/'+name_tag+'/ASA_'+plot_type+'_TD3_fixed_scale_'+name_tag+'_no_div.png')
            else:
                plt.savefig(cwd + '/experiments_results/Synergy/ASA_vs_P_'+plot_type+'_SVGplot/'+name_tag+'/ASA_'+plot_type+'_TD3_fixed_scale_'+name_tag+'_no_div.svg')
    ...
    ASA_fig_ax.set_title('ASA vs Performance ' + name_tag)
    ASA_fig_ax.set_ylabel('ASA')
    ASA_fig_ax.legend()
    ASA_fig_ax.set_xlabel('Performance')
    ...
    if get_rid_div:
        if fixed_scale:
            ...
            if not save_svg:
                plt.savefig(
                    cwd + '/experiments_results/Synergy/ASA_vs_P_' + plot_type + '_plot/' + name_tag + '/ASA_' + plot_type + '_fixed_scale_' + name_tag + '_no_div.png')
            else:
                plt.savefig(
                    cwd + '/experiments_results/Synergy/ASA_vs_P_' + plot_type + '_SVGplot/' + name_tag + '/ASA_' + plot_type + '_fixed_scale_' + name_tag + '_no_div.svg')
...
#################################################################################################################
    ...
    if plot_type=='line':
        ASA_fig_ax.plot(FPI_SAC, ASA_SAC, color=sac_color, linewidth=LW,marker="x", markersize=20,markeredgewidth=5,label='SAC')
        if name_tag != 'VA' and name_tag !='RealArmAllv4':
            ASA_fig_ax.fill_between(FPI_SAC, ASA_SAC + ASA_SAC_std,
                                ASA_SAC - ASA_SAC_std, facecolor=sac_color, alpha=trans_rate)

        for index,d in enumerate(Dof_list):
            ASA_fig_ax.text(FPI_SAC[index]*1.01,ASA_SAC[index]*0.95,d+ ' DOF',va='center',  ha='left')

    ASA_fig_ax.set_title('ASA vs Performance-Energy '+name_tag+' SAC')
    ASA_fig_ax.set_ylabel('ASA')
    ASA_fig_ax.legend()
    ASA_fig_ax.set_xlabel('Performance-Energy')
    ...
    if get_rid_div:
        if fixed_scale:
            if not save_svg:
                plt.savefig(cwd + '/experiments_results/Synergy/ASA_vs_P_'+plot_type+'_plot/'+name_tag+'/ASA_PI_'+plot_type+'_SAC_fixed_scale_'+name_tag+'_no_div.png')
            else:
                plt.savefig(cwd + '/experiments_results/Synergy/ASA_vs_P_'+plot_type+'_SVGplot/'+name_tag+'/ASA_PI_'+plot_type+'_SAC_fixed_scale_'+name_tag+'_no_div.svg')
    ...
    if plot_type=='line':
        ASA_fig_ax.plot(FPI_TD3, ASA_TD3, color=td3_color, linewidth=LW,marker=".", markersize=20,markeredgewidth=5,label='TD3')
        if name_tag != 'VA' and name_tag !='RealArmAllv4':
            ASA_fig_ax.fill_between(FPI_TD3, ASA_TD3 + ASA_TD3_std,
                                ASA_TD3 - ASA_TD3_std, facecolor=td3_color, alpha=trans_rate)

        for index,d in enumerate(Dof_list):
            ASA_fig_ax.text(FPI_TD3[index]*1.01,ASA_TD3[index]*0.9,d+ ' DOF',va='center',  ha='left')


    ASA_fig_ax.set_title('ASA vs Performance-Energy '+name_tag+' TD3')
    ASA_fig_ax.set_ylabel('ASA')
    ASA_fig_ax.legend()
    ASA_fig_ax.set_xlabel('Performance-Energy')
    ...
    if get_rid_div:
        if fixed_scale:
            ...
            if not save_svg:
                plt.savefig(cwd + '/experiments_results/Synergy/ASA_vs_P_'+plot_type+'_plot/'+name_tag+'/ASA_PI_'+plot_type+'_TD3_fixed_scale_'+name_tag+'_no_div.png')
            else:
                plt.savefig(cwd + '/experiments_results/Synergy/ASA_vs_P_'+plot_type+'_SVGplot/'+name_tag+'/ASA_PI_'+plot_type+'_TD3_fixed_scale_'+name_tag+'_no_div.svg')
    ...
    ASA_fig_ax.set_title('ASA vs Performance-Energy ' + name_tag)
    ASA_fig_ax.set_ylabel('ASA')
    ASA_fig_ax.legend()
    ASA_fig_ax.set_xlabel('Performance-Energy')
    ...
    if get_rid_div:
        if fixed_scale:
            if not save_svg:
                plt.savefig(
                    cwd + '/experiments_results/Synergy/ASA_vs_P_' + plot_type + '_plot/' + name_tag + '/ASA_PI_' + plot_type + '_fixed_scale_' + name_tag + '_no_div.png')
            else:
                plt.savefig(
                    cwd + '/experiments_results/Synergy/ASA_vs_P_' + plot_type + '_SVGplot/' + name_tag + '/ASA_PI_' + plot_type + '_fixed_scale_' + name_tag + '_no_div.svg')
...
#################################################################################################################
    ...
    if plot_type=='line':
        ASA_fig_ax.plot(FE_SAC, ASA_SAC, color=sac_color, linewidth=LW,marker="x", markersize=20,markeredgewidth=5,label='SAC')

        if name_tag != 'VA' and name_tag !='RealArmAllv4':
            ASA_fig_ax.fill_between(FE_SAC, ASA_SAC + ASA_SAC_std,
                                ASA_SAC - ASA_SAC_std, facecolor=sac_color, alpha=trans_rate)
    ...
    if get_rid_div:
        if fixed_scale:
            if not save_svg:
                plt.savefig(cwd + '/experiments_results/Synergy/ASA_vs_P_'+plot_type+'_plot/'+name_tag+'/ASA_E_'+plot_type+'_SAC_fixed_scale_'+name_tag+'_no_div.png')
            else:

                plt.savefig(cwd + '/experiments_results/Synergy/ASA_vs_P_'+plot_type+'_SVGplot/'+name_tag+'/ASA_E_'+plot_type+'_SAC_fixed_scale_'+name_tag+'_no_div.svg')
    ...
    if plot_type=='line':
        ASA_fig_ax.plot(FE_TD3, ASA_TD3, color=td3_color, linewidth=LW,marker=".", markersize=20,markeredgewidth=5,label='TD3')
        if name_tag != 'VA' and name_tag !='RealArmAllv4':
            ASA_fig_ax.fill_between(FE_TD3, ASA_TD3 + ASA_TD3_std,
                                ASA_TD3 - ASA_TD3_std, facecolor=td3_color, alpha=trans_rate)
    ...
    if get_rid_div:
        if fixed_scale:
            if not save_svg:
                plt.savefig(cwd + '/experiments_results/Synergy/ASA_vs_P_'+plot_type+'_plot/'+name_tag+'/ASA_E_'+plot_type+'_TD3_fixed_scale_'+name_tag+'_no_div.png')
            else:
                plt.savefig(cwd + '/experiments_results/Synergy/ASA_vs_P_'+plot_type+'_SVGplot/'+name_tag+'/ASA_E_'+plot_type+'_TD3_fixed_scale_'+name_tag+'_no_div.svg')
    ...
    if get_rid_div:
        if fixed_scale:
            if not save_svg:
                plt.savefig(
                    cwd + '/experiments_results/Synergy/ASA_vs_P_' + plot_type + '_plot/' + name_tag + '/ASA_E_' + plot_type + '_fixed_scale_' + name_tag + '_no_div.png')
            else:

                plt.savefig(
                    cwd + '/experiments_results/Synergy/ASA_vs_P_' + plot_type + '_SVGplot/' + name_tag + '/ASA_E_' + plot_type + '_fixed_scale_' + name_tag + '_no_div.svg')
